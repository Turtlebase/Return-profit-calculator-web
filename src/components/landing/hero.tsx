  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="container relative z-10 py-24 sm:py-32 lg:py-40 text-center">
        <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl font-headline bg-gradient-to-br from-foreground to-foreground/70 text-transparent bg-clip-text">
